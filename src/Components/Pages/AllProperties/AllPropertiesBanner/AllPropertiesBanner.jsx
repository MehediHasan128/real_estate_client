        ...
        <Box className="lg:w-[80%] mx-auto text-black">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="relative">
              <input
                {...register('search')}
                className="w-full px-5 lg:px-10 py-3 lg:py-4 rounded-full lg:text-lg outline-none focus:outline-none"
                type="text"
                placeholder="Search your dream"
              />
              <button className="absolute top-0 right-0 h-full rounded-r-full" type="submit">
                <IoSearchOutline className="text-xl lg:text-3xl hover:text-blue-400 duration-500 border-l w-full px-6 lg:px-10" />
              </button>
            </div>
          </form>
        </Box>
